{
    ...
    // [NT-FIX 6] was a literal 0.04; now driven by the _SpecularF0 property (same default).
    half specular = _SpecularF0;
    ...
    sd.postadd += specularTerm * NdotL * fresnelTerm * NTMaskValue(sd.mask, _SpecularMaskChannel) * light.color * lerp(_SpecularColor.rgb, sd.albedoAlpha.rgb * _SpecularColor.rgb, _SpecularMultiplyAlbedo);
}
